...
class InputEmbeddings(nn.Module):
    ...
    def forward(self, x):
        ...
        # Scale by sqrt(d_model) as in the original paper (§3.4)
...
class MultiHeadAttentionBlock(nn.Module):
    def __init__(self, d_model: int, h: int, dropout: float) -> None:
        ...
        self.attention_scores = None  # stored for visualization
    ...
    def forward(self, q, k, v, mask):
        ...
        # Merge heads: (batch, h, seq_len, d_k) --> (batch, seq_len, d_model)
...
def build_transformer(
    ...
    for _ in range(N):
        decoder_blocks.append(
            DecoderBlock(
                d_model,
                MultiHeadAttentionBlock(d_model, h, dropout),  # masked self-attention
    ...
    # Xavier uniform initialization — helps avoid vanishing/exploding gradients at the start
